...
void Player::updateAnimation()
{
	...
	else if (this->animationState == PlayerAnimationStates::JUMPING)
	{
		...
		// matek: v_jump + g * t = 0 egyenlet adja meg hogy mikor �r a tetej�re. ebb�l g * t = -v_jump. t itt a frame sz�mot jelenti
		// mivel 60 fps-sel megy�nk ez a k�plet adja meg hogy milyen temp�ba menjen az anim�ci�. valszeg tr� �s ezen v�ltoztatni k�ne majd
		// bugzik is rendesen
